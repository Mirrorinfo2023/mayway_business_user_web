        ...
        <Layout>
              ...
              <Grid item={true} justifyContent='center' xs={12} >
                    ...
                    <Item
                            ...
                            <Typography variant="h6" component="div">
                                ...
                                >
                                {masterReport.totalAffilatelinkListCount ?? 0}
                                </Box>
                                {/* <Box
                                sx={{
                                    display: 'inline',
                    ...
                    <Item
                            ...
                            <Typography variant="h6" component="div">
                                ...
                                >
                                :{masterReport.totalActiveAffilatelinkList ?? 0}
                                </Box>
                                <Typography variant="h2" sx={{ padding: 1,fontSize: '22px' }}>Active</Typography>
                            </Typography>
                            </Item>
                    </Grid>
                    <Grid item xs={4} display={'inline-block'} justifyContent={'space-between'} alignItems={'center'} mt={1} mb={1}  mr={8} style={{width: '19%', verticalAlign: 'top'}}>
                    <Item
                            ...
                            <Typography variant="h6" component="div">
                                ...
                                >
                                : {masterReport.totalInactiveAffilatelinkList ?? 0}
                                </Box>
                                <Typography variant="h2" sx={{ padding: 1,fontSize: '22px' }}>Inactive</Typography>
                            </Typography>
                            </Item>
                    </Grid>
                    <Grid item xs={4} display={'inline-block'} justifyContent={'space-between'} alignItems={'center'} mt={1} mb={1}  mr={8} style={{width: '19%', verticalAlign: 'top'}}>
                    <Item
                            ...
                            <Typography variant="h6" component="div">
                                ...
                                >
                                :{masterReport.totalDeleteAffilatelinkList ?? 0}
                                </Box>
                                <Typography variant="h2" sx={{ padding: 1,fontSize: '22px' }}>Deleted</Typography>
                            </Typography>
                            </Item>
                    </Grid>
            ...
            <Grid item={true} xs={12}   >
              <TableContainer component={Paper} >
                ...
                <Box display={'inline-block'} justifyContent={'space-between'} alignItems={'center'}  mt={2} sx={{width: '25%',verticalAlign: 'top'}}  >
                            <Button variant="contained"  style={{ marginRight: '5px' }} href={`/add-new-affiliate-link/`}>
                               AddNew Affiliate Link
                            </Button>
                            <Button variant="contained" href={`/affiliate-link-category/`} >
                               Category
                            </Button>
                    </Box>
              </TableContainer>
