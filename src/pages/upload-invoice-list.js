...
function AffiliateInvoiceHistory(props) {
    ...
    useEffect(() => {
        const getTnx = async () => {
          ...
          try {
            const response = await api.post('/api/affiliate_link/get-affiliate-upload-invoice-report', reqData);
        ...
        <Layout>
            ...
            <Grid item={true} xs={12}   >
              <TableContainer component={Paper} >
                ...
                <Box display={'inline-block'} justifyContent={'space-between'} alignItems={'right'} mt={1} mb={1} style={{width: '28%', verticalAlign: 'top'}} >
                    <Typography variant="h5"  sx={{ padding: 2 }}>Affiliate Upload Invoice List</Typography>
                </Box>
