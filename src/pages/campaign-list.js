            ...
            <Grid item={true} xs={12}   >
              ...
              <TableContainer component={Paper} >
                ...
                <Box display={'inline-block'} justifyContent={'space-between'} alignItems={'right'} mt={1} mb={1} style={{width: '70%', verticalAlign: 'top'}} >
                    <Typography variant="h5"  sx={{ padding: 2 }}>Campaigns</Typography>
                </Box>

              
                <Box display={'inline-block'} justifyContent={'space-between'} alignItems={'center'} mt={3} mb={1} sx={{width: '15%', verticalAlign: 'top', padding: '0 10px' }}>
                ...
                <Box display={'inline-block'} justifyContent={'space-between'} alignItems={'center'} mt={3} mb={1} sx={{ verticalAlign: 'top' }}>
                    <Button variant="contained" size="small" color="success" style={{ fontWeight: 'bold' }} onClick={() => handleOKButtonClick()}>Get Campaign</Button>
                </Box>
